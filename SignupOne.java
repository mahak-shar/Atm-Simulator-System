...
public class SignupOne extends JFrame implements ActionListener {
    ...
    public SignupOne(){
        ...
        personalDetails.setBounds(250,50,400,30);
        add(personalDetails);
        ...
        fname.setBounds(100,135,200,30);
        add(fname);

        fnameTextField=new JTextField();
        fnameTextField.setFont(new Font("Raleway",Font.BOLD,14));
        fnameTextField.setBounds(300,135,400,30);
        add(fnameTextField);
        ...
        gender.setBounds(100,205,200,30);
        add(gender);
        //to make radio buttons
        male=new JRadioButton("MALE");
        male.setBounds(300,205,60,30);
        male.setBackground(Color.WHITE);
        add(male);
        female=new JRadioButton("FEMALE");
        female.setBounds(450,205,120,30);
        ...
        marital.setBounds(100,275,200,30);
        add(marital);
        married=new JRadioButton("MARRIED");
        married.setBounds(300,275,100,30);
        married.setBackground(Color.WHITE);
        add(married);
        unmarried=new JRadioButton("UNMARRIED");
        unmarried.setBounds(450,275,100,30);
        unmarried.setBackground(Color.WHITE);
        add(unmarried);
        other=new JRadioButton("OTHER");
        other.setBounds(630,275,100,30);
        ...
        address.setBounds(100,310,200,30);
        add(address);

        addressTextField=new JTextField();
        addressTextField.setFont(new Font("Raleway",Font.BOLD,14));
        addressTextField.setBounds(300,310,400,30);
        add(addressTextField);


        JLabel city=new JLabel("City:");
        city.setFont(new Font("Raleway",Font.BOLD,20));
        city.setBounds(100,345,200,30);
        add(city);

        cityTextField=new JTextField();
        cityTextField.setFont(new Font("Raleway",Font.BOLD,14));
        cityTextField.setBounds(300,345,400,30);
        add(cityTextField);
        ...
        stateTextField.setBounds(300,380,400,30);
        add(stateTextField);

        JLabel pincode=new JLabel("Pin Code:");
        pincode.setFont(new Font("Raleway",Font.BOLD,20));
        pincode.setBounds(100,415,200,30);
        add(pincode);

        pinTextField=new JTextField();
        pinTextField.setFont(new Font("Raleway",Font.BOLD,14));
        pinTextField.setBounds(300,415,400,30);
        add(pinTextField);
